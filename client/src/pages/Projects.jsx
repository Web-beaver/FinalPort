...
function Projects() {
  ...
  useEffect(() => {
    ...
    // const cardEle = document.querySelectorAll("div[class='card']");
    // const minicircle = document.getElementById("minicircle");
    // console.log(minicircle,cardEle);
    // cardEle.forEach((ele)=>ele.addEventListener("mouseenter",(dets)=>{
    //   gsap.to("#minicircle",4,{
    //     translateX:dets.clientX,
    //     translateY:dets.clientY,
    //     scale:4
    //   });
    // }))
    // cardEle.forEach((ele)=>ele.addEventListener("mouseleave",()=>{
    //   gsap.to("#minicircle",.1,{
    //     scale:1
    //   });
    // }))
  }, [])
